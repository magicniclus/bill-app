...
/**
 * Il prend un objet de facture comme argument et renvoie une chaîne de code HTML qui représente une
 * ligne de table
 * @param bill - l'objet facture
 * @returns Une chaîne de code HTML.
 */
const row = (bill) => {
  return (`
    <tr>
 ...
 * @returns Une fonction qui prend des données et renvoie une chaîne HTML.
 */
const rows = (data) => {
